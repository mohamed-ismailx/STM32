...
u8 __RCC_Enable_Peripherals_Clock__(u8 No_Enable_Peripheral_Clock);   //Prototype Of Function To Enable Clock Throw Peripherals By The Buses And Name Of Peripherals


Buses_Peripherals_Clock_Enable Enable_Clock_Peripheral;    //Object From Structure To Configuration The Bus And Peripheral To Cross It Throw Function That Enable Clock
Buses_Peripherals_Clock_Enable Disable_Clock_Peripheral;   //Object From Structure To Configuration The Bus And Peripheral To Cross It Throw Function That Disable Clock
