...
typedef struct
{
	GPIO_Port_Selection Portx;				//Object From Enum For Access Port Configuration
	GPIO_Pin_Selection Pinx;					//Object From Enum For Access Pin Configuration
	GPIO_Mode_Selection Modex;		//Object From Enum For Access Mode Configuration
...
u8 __GPIO_Set_Pin_Direction__(const GPIO_Pin_Configuration *Data);   //Prototype Of Function That Configuration The Pin Direction
u8 __GPIO_Write_Pin_HIGH__(const GPIO_Pin_Configuration *Data);   //Prototype Of Function That Configuration The Pin Output (HIGH)
u8 __GPIO_Write_Pin_LOW__(const GPIO_Pin_Configuration *Data);   //Prototype Of Function That Configuration The Pin Output (LOW)
u8 __GPIO_Toggle_Pin__(const GPIO_Pin_Configuration *Data);  //Prototype Of Function That Toggle Pin
u8 __GPIO_Read_Pin__(const GPIO_Pin_Configuration *Data);      //Prototype Of Function That Read Pin Value
u8 __GPIO_Set_Port_Direction__(const GPIO_Port_Configuration *Data); //Prototype Of Function That Configuration The Port Direction
u8 __GPIO_Write_Port_HIGH__(const GPIO_Port_Configuration *Data);   //Prototype Of Function That Configuration The Port Output (HIGH)
u8 __GPIO_Write_Port_LOW__(const GPIO_Port_Configuration *Data);    //Prototype Of Function That Configuration The Port Output (LOW)
u8 __GPIO_Read_Port__(const GPIO_Port_Configuration *Data);		//Prototype Of Function That Read Port Value
u8 __GPIO_Toggel_Port__(const GPIO_Port_Configuration *Data);  //Prototype Of Function That Toggle Port
u8 __GPIO_Reverse_Port__(const GPIO_Port_Configuration *Data); //Prototype Of Function That Reverse Port
void __GPIO_Write_Port__(u8 Portx,u16 Value);
