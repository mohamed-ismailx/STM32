...
//https://asecuritysite.com/comms/crc_div   [CRC Check Error Source]
...
u8 __SPI_One_Initialization__(SPI_One_Configuration *Data)
{
	...
	SPI_One->CRCPR = Data->CRC_Polynomial;
	SPI_One->CR1.Bit_Access.CRCEN = Data->CRC;    // ERRIE Flag
...
void __SPI_One_Disable_CRC__(void)
{
	...
	SPI_One->CR1.Bit_Access.SPE = Disable;

	SPI_One->CR1.Bit_Access.CRCEN = Disable;    // ERRIE Flag

	SPI_One->CR1.Bit_Access.CRCEN = Enable;    // ERRIE Flag
