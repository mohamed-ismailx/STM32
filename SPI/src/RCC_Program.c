...
#include "stm32f103xx.h"
	...
	void __RCC_HSE_Clock_Initialization(HSE_Configuration *RCC_HSE_Configuration)  //Definition Of Function To Initialization The HSE Clock
	{
		...
		RCC->CFGR.Bits_Access.SW = RCC_HSE_Configuration->SYSCLK_Source_Selection;  //Update The SYSCLK Source Selection(HSI/HSE/PLL) To SW Bits
	...
	void __RCC_HSI_Clock_Initialization(HSI_Configuration *RCC_HSI_Configuration)  //Definition Of Function To Initialization The HSI Clock
	{
		...
		RCC->CFGR.Bits_Access.SW = RCC_HSI_Configuration->SYSCLK_Source_Selection;  //Update The SYSCLK Source Selection(HSI/HSE/PLL) To SW Bits
...
u8 __RCC_Enable_Peripherals_Clock__(u8 No_Enable_Peripheral_Clock,Buses_Peripherals_Clock_Enable *Data)     //Definition Of Function To Enable Clock Throw Peripherals By The Number Of Peripherals
{
	...
	{
		Execution_State = __RCC_Enable_Peripheral_Clock__(&Data[Loop]);   //Call The Function Of Enable Peripheral By Bus And Peripheral Parameters
