...
u8 __GPIO_Set_Pin_Direction__(const GPIO_Pin_Configuration *Data)  //Definition Of Function That Configuration The Pin Direction
{
...
u8 __GPIO_Write_Pin_HIGH__(const GPIO_Pin_Configuration *Data)       //Definition Of Function That Configuration The Pin Output (HIGH)
{
...
u8 __GPIO_Write_Pin_LOW__(const GPIO_Pin_Configuration *Data)
{
...
u8 __GPIO_Toggle_Pin__(const GPIO_Pin_Configuration *Data)
{
...
u8 __GPIO_Read_Pin__(const GPIO_Pin_Configuration *Data)
{
	u8 Execution_State = Execution_Correct;
	u8 Pin_Value;
...
u8 __GPIO_Set_Port_Direction__(const GPIO_Port_Configuration *Data)
{
	u8 Execution_State = Execution_Correct;
	u8 Loop;
...
u8 __GPIO_Write_Port_HIGH__(const GPIO_Port_Configuration *Data)
{
...
u8 __GPIO_Write_Port_LOW__(const GPIO_Port_Configuration *Data)
{
...
u8 __GPIO_Read_Port__(const GPIO_Port_Configuration *Data)
{
...
u8 __GPIO_Toggel_Port__(const GPIO_Port_Configuration *Data)
{
	u32 Execution_State = Execution_Correct;
...
u8 __GPIO_Reverse_Port__(const GPIO_Port_Configuration *Data)
{
	u32 Execution_State = Execution_Correct;
...
{
	GPIOx[Portx]->ODR.Register_Access = Value;
}
